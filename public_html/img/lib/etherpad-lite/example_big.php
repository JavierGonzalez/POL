...
$host = "http://www.virtualpol.com";

// By this point the user has authenticated

// Create an instance
$instance = new EtherpadLiteClient('EtherpadFTW','http://www.virtualpol.com/api'); // Example URL:  http://your.hostname.tld:8080/api --  All API calls return a JSON value as documented in the API here: https://github.com/Pita/etherpad-lite/wiki/HTTP-API
