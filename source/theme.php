...
?>
	...
	<div id="footer">
		...
		<div id="footer-right" style="text-align:center;">
			<p>
            <a href="//www.virtualpol.com" title="VirtualPol"><img src="<?=IMG?>logo/vp2.png" width="200" height="60" alt="VirtualPol" /></a>
			</p>
			...
			<span title="Epoca antigua en IRC" style="color:#999;">2004-</span>2008-2019
            <br />
			<span style="color:#BBB;">
            <?=num((microtime(true)-TIME_START)*1000).'ms '.num(memory_get_usage()/1000).'kb'?>
			</span>
            </p>
		</div>
