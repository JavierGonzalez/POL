...
<td width="100%" border="0">'.(isset($pol['user_ID'])?'<input type="text" id="vpc_msg" name="msg" onKeyUp="msgkeyup(event,this);" onKeyDown="msgkeydown(event,this);" tabindex="1" autocomplete="off" size="65" maxlength="250" style="width:98%;" />':boton('Para participar debes crear un ciudadano', REGISTRAR.'?p='.PAIS, false, 'blue')).'</td>
