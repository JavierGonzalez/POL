...
if ($pol['estado'] == 'ciudadano') { // ciudadano
   ...
   if ($pol['cargo'] == 'soldado') {$texto = "https://spreadsheets.google.com/ccc?key=0AvOPYcHW84zQdE9hb1JVamowUXVOVXpfdkNNTXNKV3c&hl=es&pli=1#gid=1"; } else {$texto = ""; }
	$txt_perfil = $texto.'<a href="/perfil/' . $pol['nick'] . '/">' . $pol['nick'] . ' ' . $cargo_icono . '</a> | <a href="/pols/"><b>' . pols($pol['pols']) . '</b> ' . MONEDA . '</a> | <a href="/msg/" title="Mensajes">(' . $num_msg . ') <img src="'.IMG.'email.gif" alt="Mensajes" border="0" style="margin-bottom:-5px;" /></a> | <a href="/foro/mis-respuestas/" title="Respuestas a tus mensajes en el foro">Resp</a> |' . $elecciones . ' <a href="/accion.php?a=logout">Salir</a>';} elseif ($pol['estado'] == 'extranjero') { // extranjero
