...
while($r = r($result)) {
	...
	echo '<tr style="background:'.$pais_config['bg_color'].';'.($r['num']<0?'display:none;" class="p-inactiva"':'"').'>
...
echo '<tr><td style="border-bottom:1px solid grey;" colspan="2"><!--<a href="#" onclick="$(\'tr .p-inactiva\').toggle();return false;">'._('Ver todas las plataformas').'</a>--></td></tr>
