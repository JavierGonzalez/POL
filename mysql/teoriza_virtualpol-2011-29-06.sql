...
CREATE TABLE `chats_msg` (
  ...
  KEY `user_ID` (`user_ID`),
  KEY `tipo` (`tipo`)
) ENGINE=MyISAM AUTO_INCREMENT=899379 DEFAULT CHARSET=latin1;
...
CREATE TABLE `mensajes` (
  ...
  KEY `leido` (`leido`),
  KEY `time` (`time`)
) ENGINE=MyISAM AUTO_INCREMENT=120933 DEFAULT CHARSET=latin1;
...
CREATE TABLE `referencias` (
  ...
  KEY `user_ID` (`user_ID`),
  KEY `pagado` (`pagado`)
) ENGINE=MyISAM AUTO_INCREMENT=8903 DEFAULT CHARSET=latin1;
...
CREATE TABLE `users` (
  ...
  KEY `pais` (`pais`),
  KEY `ref_num` (`ref_num`)
) ENGINE=MyISAM AUTO_INCREMENT=203211 DEFAULT CHARSET=latin1;
...
CREATE TABLE `votacion_votos` (
  ...
  PRIMARY KEY  (`ID`),
  KEY `ref_ID` (`ref_ID`)
) ENGINE=MyISAM AUTO_INCREMENT=13424 DEFAULT CHARSET=latin1;
...
CREATE TABLE `vp_estudios_users` (
  ...
  KEY `user_ID` (`user_ID`)
) ENGINE=MyISAM AUTO_INCREMENT=5404 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=495 DEFAULT CHARSET=latin1 COMMENT='(ID, examen_ID, user_ID, time, pregunta, respuestas, tiempo)';
...
CREATE TABLE `vp_foros_hilos` (
  ...
  KEY `estado` (`estado`)
) ENGINE=MyISAM AUTO_INCREMENT=6621 DEFAULT CHARSET=latin1;
...
CREATE TABLE `vp_foros_msg` (
  ...
  KEY `time` (`time`),
  KEY `estado` (`estado`)
) ENGINE=MyISAM AUTO_INCREMENT=67493 DEFAULT CHARSET=latin1;
...
CREATE TABLE `vp_transacciones` (
  ...
  KEY `time` (`time`)
) ENGINE=MyISAM AUTO_INCREMENT=21074 DEFAULT CHARSET=latin1;
