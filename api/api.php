...
LIMIT 500", $link);
					while($r2 = mysqli_fetch_array($result2)){ 
						...
						echo $r2['ID'].'|'.$r2['pols'].'|'.$r2['emisor_ID'].'|'.$r2['receptor_ID'].'|'.strtotime($r2['time']).'|'.$r2['concepto']."|\n";
					}
				}
				if (!$txt) { $txt = 'error'; }
				break;
...
<p>Ejemplo: <em>https://pol.virtualpol.com/api?pass=55d4bf2edf8b&a=debug</em></p>
...
<b style="color:green;">https://pol.virtualpol.com/api.php?pass=CLAVE_API</b></p>
...
<p><a href/"><b>https://pol.virtualpol.com/</b></a></p>
</body></html>
