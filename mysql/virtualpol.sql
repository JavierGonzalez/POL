...
CREATE TABLE `cargos_users` (
  ...
  KEY `pais` (`pais`),
  KEY `nota` (`nota`)
) ENGINE=MyISAM AUTO_INCREMENT=8543 DEFAULT CHARSET=utf8;
CREATE TABLE `cat` (
...
CREATE TABLE `chats_msg` (
  ...
  KEY `msg` (`msg`(333)),
  KEY `IP` (`IP`)
) ENGINE=MyISAM AUTO_INCREMENT=3074064 DEFAULT CHARSET=latin1;
CREATE TABLE `config` (
  `ID` smallint(5) unsigned NOT NULL auto_increment,
...
CREATE TABLE `hispania_foros_msg` (
  ...
  KEY `time` (`time`),
  KEY `estado` (`estado`)
) ENGINE=MyISAM AUTO_INCREMENT=39859 DEFAULT CHARSET=utf8;
...
CREATE TABLE `hispania_transacciones` (
  ...
  KEY `receptor_ID` (`receptor_ID`),
  KEY `time` (`time`)
) ENGINE=MyISAM AUTO_INCREMENT=58376 DEFAULT CHARSET=latin1;
CREATE TABLE `kicks` (
  `ID` mediumint(9) unsigned NOT NULL auto_increment,
  `pais` enum('15M','Hispania','RSSV') default NULL,
...
CREATE TABLE `mensajes` (
  ...
  KEY `leido` (`leido`),
  KEY `time` (`time`)
) ENGINE=MyISAM AUTO_INCREMENT=183305 DEFAULT CHARSET=utf8;
CREATE TABLE `notificaciones` (
  ...
  KEY `url` (`url`),
  KEY `texto` (`texto`)
) ENGINE=MyISAM AUTO_INCREMENT=52504 DEFAULT CHARSET=utf8;
...
CREATE TABLE `stats` (
  ...
  KEY `time` (`time`),
  KEY `pais` (`pais`)
) ENGINE=MyISAM AUTO_INCREMENT=2814 DEFAULT CHARSET=latin1;
CREATE TABLE `users` (
  `ID` mediumint(8) unsigned NOT NULL auto_increment,
  ...
  KEY `x` (`x`),
  KEY `y` (`y`)
) ENGINE=MyISAM AUTO_INCREMENT=212028 DEFAULT CHARSET=utf8;
...
CREATE TABLE `votacion_votos` (
  ...
  KEY `validez` (`validez`),
  KEY `time` (`time`)
) ENGINE=MyISAM AUTO_INCREMENT=91656 DEFAULT CHARSET=latin1;
CREATE TABLE `votos` (
  ...
  KEY `pais` (`pais`),
  KEY `voto` (`voto`)
) ENGINE=MyISAM AUTO_INCREMENT=83903 DEFAULT CHARSET=latin1;
