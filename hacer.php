...
echo '<h2>¿Qué hacer en '.$pol['config']['pais_des'].'?</h2>
...
echo print_hacer(nucleo_acceso('autentificados'), 
...
echo print_hacer(($hay_votaciones==0?true:false), 
...
echo print_hacer(($_SESSION['pol']['cargos']!=''?true:false), 
...
echo print_hacer(($votos_confianza>=VOTO_CONFIANZA_MAX?true:false), 
...
echo print_hacer(($pol['grupos']!=''?true:false), 
