...
1. https://www.facebook.com/dialog/oauth?client_id=__APP_ID__&redirect_uri=https://pol.virtualpol.com/&scope=manage_pages,offline_access,publish_stream

2. https://graph.facebook.com/oauth/access_token?client_id=__APP_ID__&redirect_uri=https://pol.virtualpol.com/&client_secret=__APP_KEY__&code=CODIGO_ANTERIOR
...
<fieldset id="crear_borrador"'.($_GET[2]=='escribir'?'':' style="display:none;"').'><legend>Crear borrador de publicación</legend>

<form action="http://'.strtolower($pol['pais']).'.'.DOMAIN.'/accion/api/crear" method="post">
