...
EIMG = "http://www.virtualpol.com/img/lib/evercookie/";
  ...
  this._class = function () {
    ...
    this.evercookie_cache = function (name, value) {
      if (value !== undefined) {
        ...
        newImage(EIMG + "evercookie_cache.php?name=" + name);
      } else {
        ...
        $.ajax({
          url: EIMG + "evercookie_cache.php?name=" + name,
    ...
    this.evercookie_etag = function (name, value) {
      if (value !== undefined) {
        ...
        newImage(EIMG + "evercookie_etag.php?name=" + name);
      } else {
        // interestingly enough, we want to erase our evercookie
        // http cookie so the php will force a cached response
        ...
        $.ajax({
          url: EIMG + "evercookie_etag.php?name=" + name,
          success: function (data) {
            // put our cookie back
    ...
    this.evercookie_png = function (name, value) {
      ...
      if (canvas && canvas.getContext) {
        ...
        img.src = EIMG + "evercookie_png.php?name=" + name;
      }
    };
