...
<p><button onclick="$(\'#box_msg\').toggle(\'slow\');">Enviar mensaje</button> &nbsp; <span class="gris">Tienes <b>'.$pol['msg'].'</b> mensajes</span></p>';
...
<td nowrap="nowrap"><input id="ciudadano" tabindex="1" type="text" name="nick" value="' . $pre_nick . '" style="font-size:17px;" /> (Puedes indicar hasta 9 ciudadanos separados por espacios)</td>
</tr>
<tr onclick="click_form(\'cargos\');">
<td nowrap="nowrap"><input id="radio_cargos" type="radio" name="para" value="cargo"'.($pre_cargo?' checked="checked"':'').' />Cargos:</td>
<td nowrap="nowrap"><select name="cargo_ID" style="color:green;font-weight:bold;font-size:17px;"><option name="" value=""></option>' . $select_todoscargos . '</select> (env&iacute;o m&uacute;ltiple, cuidado)</td>
</tr>
<tr>
